...
BOARD_OFFSET_X = (WINDOW_WIDTH - board.WIDTH_PIXELS) / 2
BOARD_OFFSET_Y = (WINDOW_HEIGHT - board.HEIGHT_PIXELS) / 2
BOARD_BORDER = 1
        ...
        while True:
            ...
            pygame.draw.rect(self.display, DARK_BLUE,
                             (BOARD_OFFSET_X - BOARD_BORDER, BOARD_OFFSET_Y - BOARD_BORDER,
                              board.WIDTH_PIXELS + BOARD_BORDER * 2,
                              board.HEIGHT_PIXELS + BOARD_BORDER * 2))
